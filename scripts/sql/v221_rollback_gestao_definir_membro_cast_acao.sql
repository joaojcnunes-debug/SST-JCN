-- v221_rollback_gestao_definir_membro_cast_acao.sql
-- Reverte o v221: restaura gestao_definir_membro EXATAMENTE como estava no v116 (CASE sem cast).
-- ATENÇÃO: a versão v116 é a que sempre falha com 42804 na gravação do log — este rollback
-- devolve o BUG. Só usar se o fix precisar ser retirado por algum motivo inesperado.
