-- v205_fix_adicionar_vinculados.rollback.sql
-- Reverte GESTAO-KANBAN-01-F2-VINCFIX ao estado pré-fix (buggy): recria
--   gestao_automacao_aplicar com a linha ANTIGA do ramo adicionar_vinculados
--   (v_acao->>'tipo'), reproduzindo o corpo VIVO atual VERBATIM (com o bug).
-- + remove o registro em schema_migrations.
-- (migrate.ps1 pula arquivo com "rollback" no nome — aplicar à mão por psql -f.)
...
delete from schema_migrations where version = 'v205_fix_adicionar_vinculados';
