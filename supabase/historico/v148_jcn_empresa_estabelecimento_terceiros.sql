-- ============================================================
-- v148 (JCN) — Estabelecimento de terceiros no cadastro de empresas
-- ============================================================
-- Reflete a v140 do painel-sst.
--
...
-- segunda cópia do mesmo cadastro.
--
-- Aditiva e idempotente: as empresas existentes viram 'CLIENTE' e nada no
-- fluxo atual muda.
-- ============================================================
...
BEGIN
  ...
  IF n_clientes <> (SELECT count(*) FROM public.empresas) THEN
    RAISE EXCEPTION 'v148: nem todas as empresas ficaram como CLIENTE (% de %)',
