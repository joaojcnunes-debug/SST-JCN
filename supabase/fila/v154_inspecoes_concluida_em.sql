-- v154 — Inspeções: data de conclusão real (concluida_em).
--
...
begin
  if not exists (
    ...
    raise exception 'v154 abortada: coluna concluida_em nao foi criada';
  end if;
  raise notice 'v154 OK: inspecoes.concluida_em disponivel';
end $$;
