 ...
 *
 * 📍 Esta tela ERA a raiz `/gestao-gerencial`. Mudou para cá em 01/09, quando a
 * raiz virou a escolha por card — o painel passou a ter duas coisas chamadas
 * "escala" e quem chegava não sabia qual era qual. O conteúdo é o mesmo,
 * inclusive o link para `/gestao-gerencial/[idUnidade]`, que continua irmão
 * desta rota. Segmento estático não colide com o dinâmico: os ids são
 * `UNI-XXXXXXXX`.
 */
export default function GestaoGerencialUnidadesPage() {
