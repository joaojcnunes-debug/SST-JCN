...
export default function PsicossocialPage() {
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center py-16 text-center">
      ...
      <h1 className="mt-6 text-2xl font-bold text-gray-900">Psicossocial</h1>
      <p className="mt-2 text-sm text-gray-500">
        Módulo de gestão de riscos psicossociais e IAPAT.
      </p>

      <div className="mt-8 flex w-full items-center gap-3 rounded-xl border border-purple-200 bg-purple-50 px-4 py-3 text-left text-sm text-purple-900">
        <Construction className="size-5 shrink-0" />
        <p>
          Em construção. Em breve esta área terá fluxo próprio para
          questionários, avaliação e relatórios psicossociais.
        </p>
      </div>
