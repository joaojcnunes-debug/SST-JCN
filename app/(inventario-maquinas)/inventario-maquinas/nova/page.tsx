...
function NovaMaquinaInner() {
  // `exigeEditar`: a RLS de inventario_maquinas (v76) exige caller_pode_editar()
  // no INSERT — sem isso o cadastro só falharia no submit.
  useRequireCreate("/inventario-maquinas", { exigeEditar: true });
